...
MOV DATA3,AL    ;LOCATION DATA2 INTO 16 BIT AX
...
MOV BX,OFFSET DATA5; SEGMENT MEMORY LOCATION DATA4 THE 16 BIT OFFSET ADDRESS OF DS MEMEORY LOCATION DATA5 IS COPIED INTO BX
MOV AX,[BX+0H] ;
